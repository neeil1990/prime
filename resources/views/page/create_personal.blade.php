                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/create-personal') }}">
                            ...
                            <div class="form-group{{ $errors->has('admin') ? ' has-error' : '' }}">
                                <label class="col-md-4 control-label">Назначить администратором</label>

                                <div class="col-md-6">
                                    <input type="checkbox" class="minimal" name="admin" value="1">
                            ...
                            <div class="form-group{{ $errors->has('sum_many_last') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" class="form-control" name="sum_many_last" value="{{ old('sum_many_last') }}">
