                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/update-create-pass-context') }}">
                            ...
                            <div class="form-group{{ $errors->has('loginMyTarget') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="loginMyTarget" value="{{$users->loginMyTarget}}">
                            ...
                            <div class="form-group{{ $errors->has('passMyTarget') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="passMyTarget" value="{{$users->passMyTarget}}">
