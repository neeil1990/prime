                ...
                <div class="col-md-12 dinamic_block">
                    <div class="box box-warning">
                        ...
                        <div class="box-body" style="display: block;">
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    Архив: <a href="/archive-page-project/pass-seo">{{$count_archive}}</a>
                                </div>
                            </div>
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header">
                        @if($admin == 1)
                        <h3 class="box-title"> <a href="/pass-seo/create">Добавить</a></h3>
                            @endif
                    </div>
                    <!-- /.box-header -->
    ...
    <script>
        $(function(){
            ...
            $('.edit').click(function() {
                ...
                window.location.href='/pass-seo/'+arr+'/edit';
                return false;
            });
